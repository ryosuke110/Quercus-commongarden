...
bedtools  
vcftools  
GATK 3.8 – https://gatk.broadinstitute.org/  
(used for indel realignment)
Picard – https://broadinstitute.github.io/picard/  
bamUtil – https://genome.sph.umich.edu/wiki/BamUtil  
ANGSD – http://www.popgen.dk/angsd  
Beagle 3.3.2 – https://faculty.washington.edu/browning/beagle/beagle_3.3.2.html  
(pre-imputation)
Beagle 5.5 – https://faculty.washington.edu/browning/beagle/beagle.html  
(post-imputation)
PLINK – https://www.cog-genomics.org/plink/  
ADMIXTURE – https://dalexander.github.io/admixture/  
GEMMA – https://github.com/genetics-statistics/GEMMA  
triangulaR – https://github.com/thierrygosselin/triangulaR  
hzar – https://cran.r-project.org/package=hzar  
rehh – https://cran.r-project.org/package=rehh  
R  
Python  
PyMC – https://www.pymc.io  
missForest – https://cran.r-project.org/package=missForest  
corrplot – https://cran.r-project.org/package=corrplot  
piecewiseSEM – https://cran.r-project.org/package=piecewiseSEM  
bgc-hm – https://github.com/gompertlab/bgc  
